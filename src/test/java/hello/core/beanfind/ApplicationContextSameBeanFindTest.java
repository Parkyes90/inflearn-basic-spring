...
public class ApplicationContextSameBeanFindTest {
    ...
    void findAllBeanByType() {
        java.util.Map<java.lang.String, hello.core.member.MemberRepository> beansOfType = ac.getBeansOfType(hello.core.member.MemberRepository.class);
        for (java.lang.String key : beansOfType.keySet()) {
